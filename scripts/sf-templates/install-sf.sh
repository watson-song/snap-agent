...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "按 snap-agent-README.md 把 SnapAgent 集成到当前项目。先问我要工号用于 auth-token，然后逐步执行步骤 2 到 9，每步完成后向我确认。特别注意步骤 3b：检查项目根目录是否有 docs/skills/ 目录，如果有则自动在 pom.xml 中添加 resources 配置把宿主自有 Skill 打入 classpath。完成后执行验证和排查部分。"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
