...
async function showDesignerModal() {
    // Remove any existing designer modal to prevent duplicate IDs
    var existing = document.getElementById('designerModal');
...
async function showMarketplaceModal() {
    // Remove any existing marketplace modal to prevent duplicate IDs
    var existing = document.getElementById('marketplaceModal');
    if (existing) existing.remove();
...
async function showExperimentsModal() {
    // Remove any existing experiments modal to prevent duplicate IDs
    var existing = document.getElementById('experimentsModal');
    if (existing) existing.remove();
